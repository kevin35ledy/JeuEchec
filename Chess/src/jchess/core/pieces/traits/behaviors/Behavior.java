...
public abstract class Behavior
{
    ...
    {
       /*System.out.println("sysout dans behavior.java\nTurn : " + piece.getPlayer().getName());
       System.out.println("Piece : " + piece.getName() + " moveTo : " + sq.getPozX() +", "+sq.getPozY());
       boolean safe = ourKing.willBeSafeAfterMove(piece.getSquare(), sq);
       System.out.println("safe ? "+safe);*/
       
    	return ourKing.willBeSafeAfterMove(piece.getSquare(), sq) //roi sera safe si deplacement en sq ?
                    && (null == sq.getPiece() || piece.getPlayer() != sq.getPiece().getPlayer()) // soit on move sur case vide, soit adversaire, quin'est pas le roi
