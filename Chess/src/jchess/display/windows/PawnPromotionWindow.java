...
public class PawnPromotionWindow extends JDialog implements ActionListener
{
    ...
    public PawnPromotionWindow(Frame parent, String color)
    {
        ...
        ImageIcon knightb = new ImageIcon(GUI.loadImage("Knight-" + color + "70.png"));
        this.knightButton = new JButton(knightb);//ici ça plante
        this.bishopButton = new JButton(new ImageIcon(GUI.loadImage("Bishop-" + color + "55.png")));
        this.rookButton = new JButton(new ImageIcon(GUI.loadImage("Rook-" + color + "55.png")));
        this.queenButton = new JButton(new ImageIcon(GUI.loadImage("Queen-" + color + "55.png")));
        this.result = "";
    ...
    /** Method setting the color of promoted pawn
     * @param color The players color
     */
    public void setColor(String color)
    {
        this.knightButton.setIcon(new ImageIcon(GUI.loadImage("Knight-" + color + "55.png")));
        this.bishopButton.setIcon(new ImageIcon(GUI.loadImage("Bishop-" + color + "55.png")));
        this.rookButton.setIcon(new ImageIcon(GUI.loadImage("Rook-" + color + "55.png")));
        this.queenButton.setIcon(new ImageIcon(GUI.loadImage("Queen-" + color + "55.png")));
    }
